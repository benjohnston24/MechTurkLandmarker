function check(obj) {
    ...
    if ((obj.P1 && obj.P1[0]) < (obj.P6 && obj.P6[0])) acc.push("P6 is to the left of P1, are they switched around?");
    if ((obj.P5 && obj.P5[1]) > (obj.P6 && obj.P6[1])) acc.push("P6 is above P5, are they switched around?");
    if ((obj.P5 && obj.P5[1]) > (obj.P6 && obj.P6[1])) acc.push("P5 is above P6, are they switched around?");
    return acc;
}
